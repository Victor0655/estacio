...
int main() {
    ...
    , pib_per_capita_1, pib_per_capita_2 , super_poder_1, super_poder_2;
    int atributo_comparar , quant_atri_comp , pontos_1, pontos_2;
    ...
    super_poder_2 = pib_per_capita_2 + pontos_turisticos_2 + area_2 + populacao_2 + pib_2 + (densidade_populacional_2*-1);
/*
...
*/
    ...
    if (quant_atri_comp > 7) {
        printf("não é possivel comparar mais de 7 atributos\n");
        return 0;
    } else if (quant_atri_comp < 1) {
        printf("não é possivel comparar menos de 1 atributo\n");
        return 0;
    }
